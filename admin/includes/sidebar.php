...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3  bg-gradient-dark mt-5" id="sidenav-main">
    <div class="sidenav-header">
        <i class="fas fa-times p-3 cursor-pointer text-white position-absolute end-0 top-0 d-block d-xl-none" id="iconSidenav"></i>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?= $page === "products.php" ? 'active bg-gradient-primary' : ''; ?>" href="products.php">
                    ...
                    <span class="nav-link-text ms-1">Svi proizvodi</span>
                </a>
            </li>
            <li class="nav-item">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
        <div class="mx-3">
            <a class="btn bg-gradient-primary mt-4 w-100" href="../logout.php" type="button">Izloguj se</a>
        </div>
    </div>
</aside>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-sm-5">
                            <div class="card  mb-2">
                                <div class="card-header p-3 pt-2">
                                    ...
                                    <div class="text-end pt-1">
                                        <p class="text-sm mb-0 text-capitalize">Rezervisano</p>
                            ...
                            <div class="card  mb-2">
                                ...
                                <hr class="dark horizontal my-0">
                                <div class="card-footer p-3">
                                    <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+3% </span>nego prošlog meseca</p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-5 col-sm-5 mt-sm-0 mt-4">
                            <div class="card  mb-2">
                                <div class="card-header p-3 pt-2 bg-transparent">
                                    ...
                                    <div class="text-end pt-1">
                                        <p class="text-sm mb-0 text-capitalize ">Prihod</p>
